...
def iniciar_interfaz():
    ...
    Tooltip(entry_prefijo_estilo, "Las letras que se reemplazan en esperanto (c, g, h, j, s, u) no funcionan como afijo")
    ...
    generar_diccionario()
    Tooltip(entry_sufijo_estilo, "Las letras que se reemplazan en esperanto (c, g, h, j, s, u) no funcionan como afijo")
    ...
    entry_prueba.bind("<KeyRelease>", lambda e: entry_prueba.delete(0, tk.END) if len(entry_prueba.get()) >= 40 else None)
